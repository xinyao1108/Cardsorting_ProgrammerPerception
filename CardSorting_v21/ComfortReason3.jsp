...
<%	
    ...
    session.setAttribute("radioBtnPage",2);
    int radioBtnPage = 2;
%>
...
<body onload="enableNextButton()">
    <div class="container" style="margin: auto;">	
        <form name="Reason" method="post" action="SubmitSurvey">
        	...
        	<input type="hidden" id="radioBtnPage" name="radioBtnPage" value="<%out.print(radioBtnPage);%>">
		 	...
		 	<div class="mt-5">
			    ...
			    <p> Please select the <span class="text-primary">category</span> for each variable. (3/4)</p>
			    </ol>
			</div>
		 	...
		 	<div class="mt-5">
			    <ol style="font-weight: bold; padding: 0px;">
			    <p> Please select the <span class="text-primary">category</span> for each variable. (4/4)</p>
			    </ol>
		 	</div>
		 	<div class="row mt-1">
		    	<table class='tg'>
				    ...
				    <tbody>
					    <%for ( i = 30; i < variableList.length; i++){ %>
				         	<tr>
							     <td class="tg-0lax"><%= variableList[i] %></td>
							     <td><input type="radio" onclick="enableNextButton()" name="<%= variableList[i] %>" value="Unique Device ID" id="q1" 
							                 title="Unique Device ID" /></td>
            ...
            <div class="mt-5">
                <div class="row ml-1 mr-1 row mt-3 mb-3" style="display:<%out.print(post);%>">
                	<input id="NextButton" class="col btn btn-primary" type="submit" value="Submit" disabled>
                    <input  type="text" name="SortingType" value="Comfort" style="display: none;">
                </div>
                <div class="text-right" style="display:<%out.print(link);%>">
                    <input id="NextButton" class="col btn btn-primary" type="submit" value="Submit">
                </div>
            </div>
        </form>
