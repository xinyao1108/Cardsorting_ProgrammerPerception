...
function dragElement(elmnt) {
	...
	var obj_SC = document.getElementById("SomewhatSensitive");
	var obj_NC = document.getElementById("NotSensitive");
	var obj_C = document.getElementById("Sensitive");
	var obj_VC = document.getElementById("VerySensitive");
...
function getCard(){
	$.get(origin+'/Card', {SortingType:'Sensitive', Previous:'0'}, getCardCallback);
}
	...
	if(status == "success"){
		...
		if (card.name != "Done"){
			...
			if(card.name == "Attention Check"){
				card_description.innerHTML = "Please place this card in the Sensitive stack.";
			}else{
...
function getPreviousCard(){
	$.get(origin+'/Card', {SortingType:'Sensitive', Previous:'1'}, getPreviousCallback);
}
...
function undoSort(){
	$.post(origin+"/Undo",{SortingType:'Sensitive'}, undoCallback);
}
